...
class Posts(models.Model):
    ...
    author_id = models.ForeignKey(Authors, on_delete=models.CASCADE, null=True, related_name='author',)
...
class Comments(models.Model):
    author = models.ForeignKey(Authors, on_delete=models.CASCADE, null=True, related_name='author_post',)
